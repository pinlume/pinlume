...
class PermissionOnboardingController: NSWindowController, NSWindowDelegate {
    ...
    init() {
        ...
        window.title = L("Welcome to Pinlume")
        window.center()
    ...
    private func buildUI() {
        ...
        // Title
        let title = NSTextField(labelWithString: L("Pinlume needs one permission"))
    ...
    @objc private func openSettings() {
        ...
        statusLabel?.stringValue = L("Enable Pinlume, then try taking a screenshot")
    }
