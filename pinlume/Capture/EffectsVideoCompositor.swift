...
final class EffectsVideoCompositor: NSObject, AVVideoCompositing {
    ...
    private let contextQueue = DispatchQueue(label: "Pinlume.effects.context")
    private let renderQueue = DispatchQueue(label: "Pinlume.effects.render", qos: .userInitiated)
